...
Rails.application.config.contact_street_address_line = ENV["STOCKAID_CONTACT_STREET"].presence || "1401 Parkmoor Ave, Suite 125" # rubocop:disable Metrics/LineLength
Rails.application.config.contact_city_line = ENV["STOCKAID_CONTACT_CITY"].presence || "San Jose, CA 95126"
