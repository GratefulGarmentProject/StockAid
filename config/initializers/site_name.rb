...
Rails.application.config.contact_street_address_line = ENV["STOCKAID_CONTACT_STREET"].presence || "1777 Hamilton Avenue #2280"
...
Rails.application.config.personal_contact_email = ENV["STOCKAID_PERSONAL_CONTACT_EMAIL"].presence || "lisa@gratefulgarment.org"
